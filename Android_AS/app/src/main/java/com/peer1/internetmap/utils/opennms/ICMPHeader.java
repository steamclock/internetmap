package com.peer1.internetmap.utils.opennms;
...
public class ICMPHeader extends Object {
     ...
     * @throws java.lang.IndexOutOfBoundsException Thrown if there is not enough data to construct the
     *                                             header.
     */
     ...
     * @throws IndexOutOfBoundsException Thrown if the buffer does not have enough storage space.
     */
     ...
     * @throws IndexOutOfBoundsException is thrown if there is not sufficent data in the buffer.
     */
    ...
    public void setM_code(byte m_code) {
        this.m_code = m_code;
    }

    public void setM_checksum(short m_checksum) {
        this.m_checksum = m_checksum;
    }

    public void setM_ident(short m_ident) {
        this.m_ident = m_ident;
    }

    public void setM_sequence(short m_sequence) {
        this.m_sequence = m_sequence;
    }

    public static void setSm_seq(short sm_seq) {
        ICMPHeader.sm_seq = sm_seq;
    }
}
