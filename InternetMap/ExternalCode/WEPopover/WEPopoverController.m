...
- (void)presentPopoverFromRect:(CGRect)rect 
	...
	WEPopoverContainerViewProperties *props = self.containerViewProperties ? self.containerViewProperties : [WEPopoverContainerViewProperties defaultContainerViewProperties];
