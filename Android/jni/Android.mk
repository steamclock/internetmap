...
LOCAL_SRC_FILES := jniapi.cpp renderer.cpp common/OpenGL.cpp common/DisplayLines.cpp common/DisplayNodes.cpp \
                   ...
                   common/DefaultVisualization.cpp common/TypeVisualization.cpp common/Connection.cpp common/Node.cpp \
                   common/IndexBox.cpp common/MapData.cpp common/MapController.cpp jsoncpp/jsoncpp.cpp common/GlobeVisualization.cpp
